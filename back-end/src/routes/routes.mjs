...
import GoogleCloudData from '../GoogleCloudData.mjs';
...
const goog = new GoogleCloudData();
const lang = new LanguageTool();

goog.sentiment("does this work");
goog.syntax("does this work");
lang.LangToolCall("does this work", "", "")
...
Router.post('/upload_speech', (req,res) =>{
