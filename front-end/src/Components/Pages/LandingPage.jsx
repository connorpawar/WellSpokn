...
import demo from '../../Images/demo2.png'
  ...
  return (
    <React.Fragment>
      ...
      <AppBar position="static" color="default" elevation={0} className={classes.appBar}>
		...
		within those speeches, such as bad grammar, filler words, repetition, and other issues.
        </Typography>
		<br/><br/>
      </Container>
	  {/* End Description */}
	  ...
	  <Container maxWidth="md">
        <Grid container spacing={5}>
            <Grid item xs={12} sm={6} md={6}>
				<img src={demo} alt="Product Demo" height="400"></img>
            </Grid>
			<Grid item xs={12} sm={6} md={6}>
				<img src={demo} alt="Product Demo" height="400"></img>
            </Grid>
